 ...
 * @LastEditTime: 2020-07-16 20:33:12
 -->
<template>
  <div :class="prefix">
      ...
      this.$refs.login.validate(valid => {
        if (valid) {
          let b = JSON.stringify({
            account: '86' + this.loginModel.username,
          ...
          this.login({
            data: {
              ...this.loginModel,
              send: CryptoJS.AES.encrypt(CryptoJS.enc.Utf8.parse(b), CryptoJS.enc.Utf8.parse("1234123412ABCDEF"), {
